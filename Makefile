...
coverage-backend:
	@echo "\n▶ Coverage backend/"
	cd backend && poetry run pytest --cov --cov-branch --cov-report=xml -v && poetry run coverage report

coverage-scraper:
	@echo "\n▶ Coverage scraper/"
	cd scraper && poetry run pytest --cov --cov-branch --cov-report=xml -v && poetry run coverage report

coverage-bot:
	@echo "\n▶ Coverage bot/"
	cd bot && poetry run pytest --cov --cov-branch --cov-report=xml -v && poetry run coverage report
